...
const tableRowData = [
  {
    resolutor: {
      name: "Eduardo Antonino Garcia Salazar",
      email: "eduardo.salazar@ipejal.gob.mx",
    },
    cliente: {
      name: "Josué Yahir Pérez Gómez",
      email: "josue.perez@ipejal.gob.mx",
    },
    Id: 1720,
    status: "Abierto",
    prioridad: "Baja",
  ...
  {
    resolutor: {
      name: "Fernando Sanchez Plascencia",
      email: "fernando.sanchez@ipejal.gob.mx",
    },
    cliente: {
      name: "Fatima Sanchez Plascencia",
      email: "fatima.sanchez@ipejal.gob.mx",
    },
    Id: 1721,
    status: "Abierto",
    prioridad: "Baja",
        ...
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="pb-3 xl:pb-0">
            <p className="pb-3 text-sm font-medium text-center text-gray-500 border-b border-gray-100 dark:border-gray-800 dark:text-gray-400 xl:border-b-0 xl:pb-0 xl:text-left">
              Mostrando {startIndex + 1} a {endIndex} de {totalEntries}{" "}
              resultados
            </p>
          </div>
          <Pagination
