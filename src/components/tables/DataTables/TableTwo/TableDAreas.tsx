...
import { getDAreas } from "@/services/ticketService";
import FormularioDAreas from "@/components/form/example-form/FormularioDAreas";
type SortKey = "label";
...
export default function TableDAreas() {
  ...
  const fetchData = async() => {
    try {
     const result = await getDAreas();
     console.log(result)
    if(result){
        setTableRowData(result.data.dareas)
    }
    } catch{
        setTableRowData([])
    }
